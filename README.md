...
Pytorch implementation for the following paper:  
 [L. Liu, P. Ma, C. Wang and D. Xu, “Omnidirectional Image Quality Assessment with Knowledge Distillation,” IEEE Signal Processing Letters,  vol. 30, pp. 1562-1566, 2023, doi:10.1109/LSP.2023.3327908.](https://doi.org/10.1109/LSP.2023.3327908)
...
```
# train and evaluate the student network with mask distillation in 5-fold cross-validation manner
